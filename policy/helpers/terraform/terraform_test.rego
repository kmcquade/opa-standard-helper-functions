...
test_get_resources_by_types_submodule {
	...
	get_resources_by_types_submodule(tfplan, ["aws_sns_topic"]) == [
		{
			"address": "module.sns-topic.aws_sns_topic.alarm[0]",
			"mode": "managed",
			"type": "aws_sns_topic",
...
test_get_planned_values_submodule_variable {
	...
	get_planned_values_submodule(tfplan, "aws_sns_topic.alarm") == {
		"address": "module.s3_notification_sns.aws_sns_topic.alarm",
		"mode": "managed",
		"type": "aws_sns_topic",
		"name": "alarm",
...
test_get_planned_values {
	...
	get_planned_values(tfplan, "aws_dynamodb_table.example") == {
		"read_capacity": 20,
		"server_side_encryption": [{"enabled": false}],
	}

	get_planned_values(tfplan, "aws_dynamodb_table.example_2") == {
		"index": 0,
		"read_capacity": 30,
		"server_side_encryption": [{"enabled": true}],
	}
...
test_get_planned_values_submodule {
	...
	get_planned_values_submodule(tfplan, "aws_sns_topic.sns-alarm") == {
		"address": "module.sns-topic.aws_sns_topic.sns-alarm",
		"mode": "managed",
		"type": "aws_sns_topic",
		"name": "sns-alarm",
